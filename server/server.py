...
all_buildings=["sawmill","mine","farm","smithy","bank","oil_rig","barrack","airfield","tank_factory","shooting_galarie","poligon","post_office"]
all_army=["knight","assault_infantry","shooter","plane","tank","postman"]
